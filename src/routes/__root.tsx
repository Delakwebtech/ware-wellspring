...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Stockly is an all-in-one inventory, sales, and reporting platform. Track stock across branches, sell faster, prevent losses, and export reports in CSV or Excel." },
      { name: "author", content: "Stockly" },
      { property: "og:title", content: "Stockly — Modern Inventory Management" },
      { property: "og:description", content: "Inventory, sales, damages, credit sales, returns, multi-branch dashboards and exportable reports." },
